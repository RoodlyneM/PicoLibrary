...
class StopWatch:
    ...
    def __init__(self):
        ...
        self._StartButton = Button(17, "StartButton", buttonhandler=self)
        self._StopButton = Button(16, "StopButton", buttonhandler=self)
        ...
        self._model.addTransition(2, BTN2_PRESS, 2)
    ...
    def stateEntered(self, state):
        ...
        if state == 0:
            ...
            print('State 2 entered: Screen RESET')
            self._t1.stop()
            self._t2.stop()
        elif state == 3:
